...
<head>
    ...
    <title>Reset Your Password - Alex Okorie Foundation</title>
</head>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto;">
        ...
        <tr>
            <td style="background-color: #FFD700; padding: 20px; text-align: center;">
                <h1 style="color: #ffffff; margin: 0; font-size: 28px;">Alex Okorie Foundation</h1>
        ...
        <tr>
            <td style="background-color: #ffffff; padding: 30px;">
                ...
                <p style="line-height: 1.6; margin: 0 0 20px 0;">
                    ...
                    We received a request to reset your Alex Okorie Foundation account password on 
        ...
        <tr>
            <td style="background-color: #fff5f0; padding: 20px; font-size: 14px;">
                <p style="margin: 0; line-height: 1.6;">
                    ...
                    to keep your Alex Okorie Foundation account secure.
                </p>
            </td>
        </tr>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Password Changed - Alex Okorie Foundation</title>
</head>
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5; color: #333;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto;">
        <!-- Header -->
        ...
        <tr>
            <td style="background-color: #ffffff; padding: 30px; text-align: center;">
                ...
                <p style="line-height: 1.6; margin: 0 0 20px 0;">
                    Hello ${firstName},<br><br>
                    Great news! Your Alex Okorie Foundation account password was successfully updated 
